...
mixin _$MenuState {
  ProcessState get productState =>
      throw _privateConstructorUsedError; // @Default([]) List<CategoryModel> categories,
...
// @Default([]) List<CategoryModel> categories,
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'MenuState(productState: $productState, products: $products, tags: $tags, categorySelect: $categorySelect, tagSelect: $tagSelect, search: $search, checkReloadWhenHiddenApp: $checkReloadWhenHiddenApp, allProduct: $allProduct, menuDataView: $menuDataView, subCategorySelect: $subCategorySelect)';
  }
...
abstract class _HomeState implements MenuState {
  ...
  @override
  ProcessState get productState;
  @override // @Default([]) List<CategoryModel> categories,
  List<ProductModel> get products;
  @override
  List<TagProductModel> get tags;
  @override
