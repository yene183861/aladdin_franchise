                ...
                child: ButtonSimpleWidget(
                  ...
                  onPressed: () async {
                    ...
                    if (emptyProductCheckout) {
                      showMessageDialog(context,
                          message: S.current.order_before_payment);
                      return;
                    }
                    ...
                    try {
                      ...
                      if (state.autoSaveOrder && state.isOrderSaved) {
                        showConfirmAction(
                          ...
                          actionTitle: 'Gọi món',
                          action: () {
                            ref.read(homeProvider.notifier).handleOrderItem(
                                retry: true, loadingHome: true);
                          },
                        );
                        return;
                      }
                      ...
                      switch (state.dataBillState.status) {
                        ...
                        case PageCommonState.error:
                          showConfirmAction(
                            context,
                            message:
                                'Tiền thanh toán chưa được cập nhật chính xác',
                            actionTitle: 'Thử lại',
