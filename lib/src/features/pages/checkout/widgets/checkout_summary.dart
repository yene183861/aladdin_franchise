  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Container(
      ...
      child: error
          ...
          : CheckoutPriceSummary(price: price, loading: loading),
    );
  }
}
    ...
    return Column(
      ...
      children: [
        ...
        PriceInfoLine(
          ...
          loading: loading,
          titleTextStyle:
              AppTextStyle.bold(rawFontSize: newUI ? AppConfig.defaultRawTextSize + 1.5 : null),
