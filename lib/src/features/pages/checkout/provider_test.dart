...
class CheckoutNotifier extends StateNotifier<CheckoutState> {
  ...
  void resetInfo() {
    state = state.copyWith(
      ...
      orderHistory: [],
      // invoice
      invoiceState: const PageState(status: PageCommonState.success), invoice: null,
      // data bill
  ...
  ({
    ...
    //   case PageCommonState.loading:
    //     applyPolicy = 'Đang tiến hành áp dụng lại mã giảm giá, vui lòng chờ trong giây lát.';
    //     break;
    //   case PageCommonState.error:
    //     applyPolicy =
  ...
  String? checkTaxOrderItem({
    ...
    /// PTTT Grab, Shopee bắt buộc phải sửa thuế # 0
