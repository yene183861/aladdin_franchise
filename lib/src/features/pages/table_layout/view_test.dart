...
// class TableLayoutPageTest extends ConsumerStatefulWidget {
//   const TableLayoutPageTest({super.key});

//   @override
//   ConsumerState<ConsumerStatefulWidget> createState() => _TableLayoutPageState();
// }

// class _TableLayoutPageState extends ConsumerState<TableLayoutPageTest> {
//   late TransformationController _controller;
//   final GlobalKey _dragTargetKey = GlobalKey();
//   final GlobalKey _dragLocalTargetKey = GlobalKey();

//   double _canvasWidth = 40000;
//   double _canvasHeight = 40000;
...
//     var date = ref.watch(tableLayoutPageProvider.select((value) => value.date));
...
//                               tableLayoutPageProvider.select((value) => value.enableDragLayout));
//                           var itemSetting = ref
//                               .watch(tableLayoutPageProvider.select((value) => value.itemSetting));
//                           var data =
//                               ref.watch(tableLayoutPageProvider.select((value) => value.items));
//                           var floorSelect = ref
//                               .watch(tableLayoutPageProvider.select((value) => value.floorSelect));
//                           var reservationTimeCheck = ref.watch(tableLayoutPageProvider
//                               .select((value) => value.reservationTimeCheck));
//                           var fromTime =
//                               ref.watch(tableLayoutPageProvider.select((value) => value.fromTime));
//                           var toTime =
//                               ref.watch(tableLayoutPageProvider.select((value) => value.toTime));
//                           var date =
//                               ref.watch(tableLayoutPageProvider.select((value) => value.date));
//                           var itemDelete = ref
//                               .watch(tableLayoutPageProvider.select((value) => value.itemDelete));
...
//                                         showLogs(rawAnchor, flags: 'rawAnchor');
...
//                                       showLogs(dropPosition, flags: 'dropPosition');
//                                     },
...
//                                     final double currentZoomScale = _controller.value.entry(0, 0);
...
//                               builder: (context, ref, child) {
//                                 var items = ref
//                                     .watch(tableLayoutPageProvider.select((value) => value.items));
//                                 var exists = items
...
//                                       action: () {
//                                         ref.read(tableLayoutPageProvider.notifier).onDeleteAll();
//                                       },
//                                     );
//                                   },
//                                   text: 'Xoá tất cả',
...
//                                 );
//                                 if ((dateChange ?? []).isNotEmpty && dateChange!.first != null) {
//                                   ref
//                                       .read(tableLayoutPageProvider.notifier)
...
//                                         iconData: Icons.calendar_month, color: AppColors.textColor),
//                                     const Gap(4),
//                                     Text(
...
//                                       toDateTime = fromDateTime.add(const Duration(minutes: 120));
//                                       var endDate =
...
//                     //         ? Row(
//                     //             children: [
//                     //               CupertinoActivityIndicator(color: CustomStyle.blueRefresh),
//                     //               const Gap(4),
//                     //               Text(
//                     //                 'Đang làm mới dữ liệu đặt bàn...',
//                     //                 style: AppTextStyle.regular(
//                     //                   color: CustomStyle.blueRefresh,
//                     //                   rawFontSize: AppConfig.defaultRawTextSize - 1.0,
//                     //                 ),
//                     //               ),
//                     //             ],
...
//                     //     StatusEnum.error => allTables.isEmpty
//                     //         ? Row(
//                     //             children: [
//                     //               CupertinoActivityIndicator(color: CustomStyle.redColor),
//                     //               const Gap(4),
//                     //               Text(
//                     //                 'Thông tin bàn đặt không được cập nhật.\nSự cố: ${reservationState.message}',
//                     //                 style: AppTextStyle.regular(
//                     //                   color: CustomStyle.redColor,
//                     //                   rawFontSize: AppConfig.defaultRawTextSize - 1.0,
//                     //                 ),
//                     //               ),
//                     //             ],
