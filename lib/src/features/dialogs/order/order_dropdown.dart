...
class OrderDropdownBtn extends ConsumerStatefulWidget {
  const OrderDropdownBtn({
    super.key,
  ...
  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _OrderDropdownBtnState();
}

class _OrderDropdownBtnState extends ConsumerState<OrderDropdownBtn> {
  ...
  Widget build(BuildContext context) {
    ...
    return tablesAndOrders.when(
      ...
      data: (data) {
        ...
        WidgetsBinding.instance.addPostFrameCallback(
          (timeStamp) {
            if (check != orderSelect) {
              ref.read(homeProvider.notifier).changeOrderSelect(check);
            }
          },
        );
        return Container(
                        ...
                        children: [
                          Container(
                            ...
                            child: Icon(
                              ...
                              size: 16,
                              color: widget.iconColor ?? AppColors.mainColor,
                            ),
                          ),
                          const Gap(12),
                          Text(
