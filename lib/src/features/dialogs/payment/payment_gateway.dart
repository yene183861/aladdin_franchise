...
Future<void> onLoadPaymentGateway({
  ...
  return;
  // final result =
  //     await ref.read(checkoutPageProvider.notifier).getPaymentGateway();
  ...
  //     PaymentGatewayPage(
  //       paymentMethod:
  //           ref.read(checkoutPageProvider.notifier).getPaymentMethodSelected()!,
  ...
  //     ref.read(checkoutPageProvider.notifier).updatePaymentGatewayInfo(
