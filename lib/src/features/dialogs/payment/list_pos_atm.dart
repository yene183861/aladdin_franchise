        ...
        children: [
          ...
          Consumer(
            builder: (context, ref, child) {
              var listAtmPos = ref.watch(checkoutProvider.select((value) => value.listAtmPos));
              var state = ref.watch(checkoutProvider.select((value) => value.listAtmPosState));
                          ...
                          children: [
                            ...
                            ...listAtmPos.map(
                              (e) => Padding(
                                ...
                                child: InkWell(
                                  onTap: () {
                                    ref.read(checkoutProvider.notifier).onChangeAtmPosSelect(e);
                                  },
                                  borderRadius: AppConfig.borderRadiusMain,
                                  child: Container(
