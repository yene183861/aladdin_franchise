...
class _$UserModelImpl with DiagnosticableTreeMixin implements _UserModel {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'UserModel(id: $id, name: $name, email: $email, phone: $phone, username: $username, image: $image, address: $address, status: $status, applied: $applied, myrole: $myrole, mystatus: $mystatus)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('myrole', myrole))
      ..add(DiagnosticsProperty('mystatus', mystatus));
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, email, phone, username,
      image, address, status, applied, myrole, mystatus);
...
abstract class _UserModel implements UserModel {
  const factory _UserModel(
      ...
      final int? applied,
      final String? myrole,
      final String? mystatus}) = _$UserModelImpl;
